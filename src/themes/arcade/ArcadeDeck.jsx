  ...
  return (
    ...
    >
        ...
        {currentProjects.map((project, index) => {
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className="mt-auto flex gap-2 flex-wrap">
                  {displayStack.slice(0, 3).map((tech) => (
                    <span
                      key={tech}
                      className="px-2 py-1 text-[10px] uppercase font-mono border border-[#ff00ff] text-[#ff00ff]"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              {/* Decor Corners */}
              <div
                className={`absolute top-0 right-0 p-1 transition-colors ${isActive ? "bg-[#df00ff]" : "bg-neutral-800 group-hover:bg-[#ff00ff]"}`}
              />
              <div
                className={`absolute bottom-0 left-0 p-1 transition-colors ${isActive ? "bg-[#df00ff]" : "bg-neutral-800 group-hover:bg-[#ff00ff]"}`}
              />
            </div>
          );
        })}
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(#00000099, #00000099), linear-gradient(90deg, #00ff00, #ff00ff)",
          backgroundOrigin: "border-box",
          backgroundClip: "padding-box, border-box",
          border: "2px solid transparent",
          borderTop: "0",
