  ...
  return (
    <div className="mt-8 font-mono">
      <div className="relative mb-8 text-center">
        <h2
          className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-yellow-400 to-green-500 animate-pulse tracking-widest uppercase"
          style={{ textShadow: "0 0 20px rgba(0,255,100,0.5)" }}
        >
          BOUNTY BOARD
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {columns.map((col) => {
          ...
          return (
            <div
              key={col.id}
              className={`p-4 rounded-lg border-2 border-dashed ${col.border} ${col.bg} relative overflow-hidden group`}
            >
              ...
              <div className="flex items-center justify-between mb-4 border-b border-inherit pb-2">
                <h3
                  className={`text-xl font-bold flex items-center gap-2 ${col.color}`}
                >
                ...
                {colTasks.map((task) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className={`text-lg font-black ${col.color}`}>
                        {task.points}
                      </span>
                    </div>
                    <h4 className="font-bold text-white text-lg mb-2 leading-tight tracking-wide">
                      {task.title}
                    </h4>
