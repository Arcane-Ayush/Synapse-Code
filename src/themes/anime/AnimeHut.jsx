...
export function AnimeHut() {
  ...
  return (
    <group ref={group} scale={[0.8, 0.8, 0.8]} position={[0, -1, 0]}>
      ...
      <Cylinder args={[2.5, 2.5, 0.2, 32]} position={[0, 0.1, 0]}>
        {grassMat}
      </Cylinder>
      ...
      <group position={[0, 0.2, 0]}>
        ...
        <Box args={[1.5, 1.2, 1.2]} position={[0, 0.6, 0]}>
          {wallMat}
        </Box>
        {/* Roof */}
        <Cone
        ...
        {/* Door */}
        <Box args={[0.4, 0.7, 0.1]} position={[0, 0.35, 0.61]}>
          <meshStandardMaterial color="#5d4037" />
        </Box>
        <Sphere args={[0.04]} position={[0.15, 0.35, 0.66]}>
          <meshStandardMaterial color="#ffd700" />
        </Sphere>

        {/* Window */}
        <Box args={[0.4, 0.4, 0.1]} position={[0, 0.8, 0.61]}>
          <meshStandardMaterial color="#87ceeb" />
        </Box>

        {/* Chimney */}
        <Box args={[0.3, 0.8, 0.3]} position={[0.5, 1.5, 0.3]}>
          {woodMat}
        </Box>
        ...
        <group position={[0.5, 1.9, 0.3]} ref={smokeRef}>
          ...
          <Sphere args={[0.2]} position={[0.1, 0.4, 0]}>
            <meshStandardMaterial color="#ffffff" transparent opacity={0.5} />
          </Sphere>
          <Sphere args={[0.25]} position={[-0.1, 0.8, 0]}>
      ...
      <group position={[-1.5, 0.2, 0.5]}>
        ...
        <Cone args={[0.6, 1.2, 8]} position={[0, 1.0, 0]}>
          {grassMat}
        </Cone>
      </group>
      ...
      {/* Clouds */}
      <Sphere args={[0.4]} position={[-1.8, 2, -1]}>
        <meshStandardMaterial color="#ffffff" opacity={0.9} transparent />
      </Sphere>
      <Sphere args={[0.3]} position={[1.8, 2.5, 1]}>
        <meshStandardMaterial color="#ffffff" opacity={0.9} transparent />
      </Sphere>
    </group>
  );
}
export default AnimeHut;
